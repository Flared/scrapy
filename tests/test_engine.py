...
class CrawlerRun:
    ...
    def run(self):
        ...
        self.crawler.signals.connect(
            self.request_downloading, signals.request_downloading
        )
...
class EngineTest(unittest.TestCase):
    ...
    def _assert_visited_urls(self, run: CrawlerRun):
        ...
        urls_downloading = {rq[0].url for rq in run.reqdownloading}
        ...
        assert (
            urls_expected <= urls_downloading
        ), f"URLs not downloading: {list(urls_expected - urls_downloading)}"
